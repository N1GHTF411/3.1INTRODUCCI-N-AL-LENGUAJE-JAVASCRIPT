...
var sValorCal="";
			...
			for (i=1; i<=10; i++){
				...
				if (isNaN(sValorCapturado))
					...
					if (nCapturado == (nTabla*i)){
						...
						sValorCapturado = document.getElementById("txtResultado"+i).style="border: 4px solid #d60202; background-color: #d60202";
					}
				}
			}
	...
	if (sErr == "")
		document.write("<form><label><label>Calificacion= "+nCalif+"</label></form>");
	else
		alert(sErr);
}
